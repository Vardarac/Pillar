    ...
    if (PillarUI.mainMenuView === undefined) {
      ...
      mainMenuView.eatApple = function () {
        if (!PillarUI.mainMenuView.appleEaten) {
          ...
          PillarUI.mainMenuView.$appleImg.attr("src", "https://s3-us-west-1.amazonaws.com/vardarac-pillar-main/logo-apple-eaten.png");
      ...
      mainMenuView.resetApple = function () {
        if (PillarUI.mainMenuView.appleEaten) {
          PillarUI.mainMenuView.$appleImg.attr("src", "https://s3-us-west-1.amazonaws.com/vardarac-pillar-main/logo-apple-whole.png");
