(function(root) {
  ...
  var initializeAbout = PillarUI.initializeAbout = function() {
    if(PillarUI.aboutView === undefined) {
      ...
      aboutView.createLink("vardarac").addClass("pillar-link");
  ...
  var bindAboutEvents = PillarUI.bindAboutEvents = function () {
    ...
    $(".vardarac-link").click(function(event) {
      event.preventDefault();
      window.open("https://github.com/Vardarac");
    });
  };
  ...
  var initializeBoard = PillarUI.initializeBoard = function() {
    ...
    $gameBoard.css({
      ...
      "background-image": "url(https://s3-us-west-1.amazonaws.com/vardarac-pillar-main/leaflitter.png)",
      "background-size": "120%",
      "opacity": .75
    });
